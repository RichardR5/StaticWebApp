...
async function listiraamatud() {
    const responseData = await getDataAsJson("https://praks12-raamatud-a6fjemh0f8d4a8gv.northeurope-01.azurewebsites.net/raamatud/");
    const resultElement = document.getElementById("raamatud_result");
    resultElement.innerHTML = ""
    for (var raamat of responseData.raamatud){
        resultElement.innerHTML += '<a href="https://praks12-raamatud-a6fjemh0f8d4a8gv.northeurope-01.azurewebsites.net/raamatud/'+raamat+'"  download="'+raamat+'.txt" >' +raamat+".txt</a> " +
                '<a href="#" onclick="deleteObject(\'https://praks12-raamatud-a6fjemh0f8d4a8gv.northeurope-01.azurewebsites.net/raamatud/'+raamat+'\')" > [kustuta]</a>' +
                "<br />";
    }
}
